...
def get_constants():
    window_title = 'Rogue-like Tutorial Revised'
    ...
    colors = {
        'dark_wall': tc.Color(23, 23, 23),
        'dark_ground': tc.Color(155, 118, 83),
        'light_wall': tc.Color(50, 50, 50),
        'light_ground': tc.Color(207, 181, 59)
    }
...
def get_game_variables(constants):
    ...
    # TODO move dagger to items dict
